...
const langArr = {
    ...
    "redux" : {
        "pl" : 'Biblioteka JavaScript do zarządzania i centralizacji stanu aplikacji. Jest najczęściej używana z bibliotekami takimi jak React lub Angular do budowy interfejsów użytkownika.',
        "en" : 'JavaScript library for managing and centralizing application state. It is most commonly used with libraries such as React or Angular for building user interfaces.',
        "ru" : 'Библиотека JavaScript для управления и централизации состояния приложения. Чаще всего она используется с такими библиотеками, как React или Angular, для создания пользовательских интерфейсов.'
    }, 
    "portfolio-work" : {
        "pl" : 'Portfolio',
        "en" : 'Portfolio',
